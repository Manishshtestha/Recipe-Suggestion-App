...
const LoginPage = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            console.log("Logged in user:", result.user); // You can store this user data
    ...
    useEffect(() => {
        ...
        const maxRotation = 10; // Consistent with RegisterPage
        ...
        const handleMouseMove = (e: MouseEvent) => {
            ...
            container.style.transform = `perspective(800px) rotateX(${-rotateX}deg) rotateY(${rotateY}deg)`; // Consistent
        };

        const handleMouseLeave = () => {
            if (container) {
                container.style.transform = 'perspective(800px) rotateX(0deg) rotateY(0deg)'; // Consistent
            }
        };
