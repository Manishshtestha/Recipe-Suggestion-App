...
interface DietryFilterProps {
  selectedDietaryPreference: string;
  setSelectedDietaryPreference: (value: string) => void;
  selectedCuisine: string;
  setSelectedCuisine: (value: string) => void;
  selectedCookingMethod: string;
  setSelectedCookingMethod: (value: string) => void;
  selectedMealType: string;
  setSelectedMealType: (value: string) => void;
  selectedCookingTime: string;
  setSelectedCookingTime: (value: string) => void;
}

const DietryFilter: React.FC<DietryFilterProps> = ({
